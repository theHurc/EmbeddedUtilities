...
LIBRARY_NAME=TableDrivenStateMachine
...
gcc -o ${LIBRARY_NAME}.o -c -Wall -Werror -fpic ./src/TableDrivenStateMachine.c -I ./include -I../Common/include
...
gcc -L${PWD}/${LIBRARY_DIRECTORY} -Wl,-rpath=${PWD}/${LIBRARY_DIRECTORY} -Wall -o test.out ./test/test.c -lTableDrivenStateMachine -I ./include -I../Common/include
